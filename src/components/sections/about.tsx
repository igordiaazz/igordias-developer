    ...
    <Section id="about">
      <div className="grid grid-cols-1 gap-8 md:grid-cols-[1fr_auto] md:items-center">
        ...
        <div
          ...
          className="relative mx-auto aspect-square w-64 overflow-hidden rounded-2xl border border-border bg-card sm:w-80 md:mx-0 md:w-[28rem] md:row-span-2 md:self-center"
        >
          <Image
            src="/about/igor.webp"
